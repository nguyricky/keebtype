          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-5 md:pt-8">
            <div className="flex flex-row">
                <div className="mb-3 mr-3 md:mb-0 md:mr-4 text-center md:text-left">
                    <p className="text-secondary hover:text-accent text-sm md:text-[12px] tracking-wider transition ease-in-out delay-150 hover:-translate-y-0.5 hover:scale-105 duration-200 cursor-pointer">
                      <FontAwesomeIcon icon={faEnvelope} className="icon" /> Contact
                    </p>
                </div>
                <div className="mb-3 mr-3 md:mb-0 md:mr-4 text-center md:text-left">
                  <a href="https://ko-fi.com/rickynguyen">
                      <p className="text-secondary hover:text-accent text-sm md:text-[12px] tracking-wider transition ease-in-out delay-150 hover:-translate-y-0.5 hover:scale-105 duration-200">
            ...
            <div className="text-center md:text-right">
              <p className="text-secondary text-sm md:text-[12px] tracking-wider">
